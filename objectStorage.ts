...
async function signObjectURL({
  ...
  console.log("[signObjectURL] Request to sidecar:", request);
  ...
  console.log("[signObjectURL] Response status:", response.status);
  const responseText = await response.text();
  console.log("[signObjectURL] Response body:", responseText);
  ...
  console.log("[signObjectURL] Signed URL:", signedURL);
  return signedURL;
}
